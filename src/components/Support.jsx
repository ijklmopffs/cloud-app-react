      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        <div className="px-4 py-12">
          ...
          <p className="py-4 text-3xl text-slate-300">
            ...
            asperiores eaque iusto dolor neque excepturi rem doloribus dicta
            quos laudantium eum sit soluta aut recusandae tempore officiis amet
            ex. Vitae.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <p className="text-gray-600 text-xl">
                ...
                Laborum rem praesentium dolore, facilis earum delectus
                cupiditate ipsa eos consectetur dignissimos.
              </p>
            </div>
